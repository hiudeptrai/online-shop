  ...
  <div class="services">
     ...
     <div class="center">
       <div class="service-item">
         <i class="fa fa-tv"></i>
         <h2>LAPTOP, PC</h2>
         <p>Văn bản dịch vụ Văn bản dịch vụ Văn bản dịch vụ Văn bản dịch vụVăn bản dịch vụVăn bản dịch vụ</p>
       </div>
       <div class="service-item">
        <i class="fa fa-wifi"></i>
        <h2>Thiết bị Internet</h2>
        <p>Văn bản dịch vụ Văn bản dịch vụ Văn bản dịch vụ Văn bản dịch vụVăn bản dịch vụVăn bản dịch vụ</p>
      </div>
      <div class="service-item">
      ...
      <div class="service-item">
        ...
        <h2>Giải pháp Microsoft</h2>
        <p>Văn bản dịch vụ Văn bản dịch vụ Văn bản dịch vụ Văn bản dịch vụVăn bản dịch vụVăn bản dịch vụ</p>
      </div>
      <div class="service-item">
       <i class="fa fa-chain"></i>
       <h2>Công nghệ Blockchain</h2>
       <p>Văn bản dịch vụ Văn bản dịch vụ Văn bản dịch vụ Văn bản dịch vụVăn bản dịch vụVăn bản dịch vụ</p>
     </div>
     <div class="service-item">
