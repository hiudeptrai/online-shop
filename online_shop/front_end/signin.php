...
if (isset($_POST['dangnhap'])) 
{
    ...
    $sql="select id,pass from member where id='$username'";
...
<body style="background-color: #3598DC;">
  ...
  <header id="header" class="fixed-top d-flex align-items-center ">
    ...
    <form action="" method="post">
		...
		<div class="form-group">
    <input type="submit" name="dangnhap" value='Đăng nhập' class="btn btn-primary btn-lg" style="color: #fff"/>
        </div>
    </form>
	<div class="hint-text">Chưa phải thành viên? <a href="signup.php">Đăng ký ngay</a></div>
</div>
<!--------- Footer ----------->
<footer id="footer">
    <div class="container">
